# simeck4896_gpu.py -- Simeck48/96 implemented using CuPy for GPU
import cupy as cp
# Canonical cipher identifier for logging/checkpoint naming
cipher_name = "simmeck4896"
...
def check_testvectors():
    p = cp.array([[0x726963, 0x20646e]], dtype=cp.uint16)
    k = cp.array([[0x1a1918,0x121110,0x0a0908,0x020100]], dtype=cp.uint16)  
